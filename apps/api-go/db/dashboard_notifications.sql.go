...
// versions:
//   sqlc v1.31.1
// source: dashboard_notifications.sql
...
func (q *Queries) InsertNotification(ctx context.Context, arg InsertNotificationParams) (DashboardNotification, error) {
...
func (q *Queries) ListNotificationsByUser(ctx context.Context, arg ListNotificationsByUserParams) ([]DashboardNotification, error) {
