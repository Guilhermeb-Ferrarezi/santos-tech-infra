...
func TestTodasAsToolsRegistradas(t *testing.T) {
	...
	want := []string{
		...
		"bambu_status",
		// Workspace: quadros, tarefas, glossário.
		"boards_list", "board_get", "board_create", "board_update", "board_delete",
		"board_members_list", "board_member_add", "board_member_remove",
		"tasks_list", "task_get", "task_create", "task_update", "task_delete",
		"task_notes_list", "task_note_add",
		"task_categories_list", "task_category_create", "task_category_update", "task_category_delete",
		"glossary_list", "glossary_create", "glossary_update", "glossary_delete",
		// Conteúdo: blog, vitrine de links, calendário editorial, Instagram.
		"blog_posts_list", "blog_post_get", "blog_post_create", "blog_post_update", "blog_post_delete",
		"blog_categories_list", "blog_category_create", "blog_category_update", "blog_category_delete",
		...
		"sentry_issues_list", "sentry_issue_get", "sentry_projects_list",
		"custom_roles_list", "custom_role_create", "custom_role_get", "custom_role_update", "custom_role_delete",
		...
		"ip_bans_list", "ip_ban_create", "ip_ban_delete",
		"oauth_clients_list", "oauth_client_create", "oauth_client_update", "oauth_client_delete",
		"models3d_list", "model3d_upload", "model3d_update", "model3d_delete",
	}
	got := map[string]bool{}
